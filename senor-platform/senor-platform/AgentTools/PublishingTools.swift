...
public struct DeviantArtPublishTool: AgentTool {
    ...
    public func execute(input: String, context: ToolExecutionContext) async throws -> String {
        ...
        let allowComments = params["allow_comments"] as? Bool ?? true
        let allowDownload = params["allow_download"] as? Bool ?? false
...
// DeviantArtClient and PatreonClient are defined in the Integrations module
